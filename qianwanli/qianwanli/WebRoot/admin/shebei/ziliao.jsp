...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td  style="font-size:20px;color:red" height="30" align="center" colspan="100" background="<%=path %>/images/tbg.gif">设备资料界面</td>
				</tr>
				<c:if test="${sessionScope.userType==0}">
				<tr>
					<td height="30" align="center" colspan="100">
						<a href="<%=path %>/admin/gongwen/gongwenAdd.jsp?addtype=7" style="font-size:16px;padding:3px;border:1px solid black">添加新的设备资料</a>
					</td>
				</tr>
				</c:if>
