...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td  style="font-size:20px;color:red" height="30" align="center" colspan="100" background="<%=path %>/images/tbg.gif">运行规程党创建设界面</td>
				</tr>
				<tr>
					<td height="30" align="center" colspan="100">
						<a href="<%=path %>/admin/gongwen/gongwenAdd.jsp" style="font-size:16px;padding:3px;border:1px solid black">添加新的党创建设活动</a>
					</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<a href="#" onclick="down1('${gongwen.fujian}','附件.doc')" style="font-size: 10px;color: red">附件在线预览</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
						${gongwen.beizhu}
					</td>
