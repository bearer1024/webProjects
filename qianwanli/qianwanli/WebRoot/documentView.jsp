<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String swfFilePath=request.getParameter("swfpath").toString();
...
<body> 
        <div style="position:absolute;left:10px;top:10px;">
	        <a id="viewerPlaceHolder" style="width:1000px;height:750px;display:block" ></a>
...
<%--SwfFile : escape('<%=swfFilePath%>'),--%>
				var fp = new FlexPaperViewer(	
						 ...
						 SwfFile : escape('<%=swfFilePath%>'),
						 //SwfFile : escape('upload/baodao.swf'),//需要使用Flexpaper打开的文档
						 Scale : 1.4, 						//初始化缩放比例，参数值应该是大于零的整数
