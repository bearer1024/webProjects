...
<!--    <span id="Clock">2011年4月13日   10:34:56</span>-->
    <span id="Clock"></span>
</div>
...
<!--  <table width="500"  height="180"  border="0" align="center" cellpadding="0" cellspacing="0">-->
  <table style="width:500px; border:0; align:center; cellpadding=0; cellspacing=0">
  <tr>
...
<div class="index_c_tel">
	...
	<div id="tel_text2">
	 ...
	 <br>
	 <span style="font-size:14px; font-weight:bold; color:#fe620c;">节假无休，服务全县</span>
	</div>
	<div id="tel_bot"></div>
</div>
...
<img src="images/index_jybd_right.jpg" width="6" id="jybd_r" height="30" /></div><div  style="height:233px; margin-top:-5px; _margin-top:0px; border:1px #CCCCCC solid;  border-top:0px solid #CCC;">
...
<map name="Map3"><area shape="rect" coords="147,10,181,19" href="link.php">
    ...
    <div class="index_yqlj" style="height:188px">
    <?php
		//selectMany($param,$tbname,$where,$order,$limit)
...
<map name="jykrMap"><area shape="rect" coords="0,11,32,21" href="article.php?sid=10">
    ...
    <div class="index_jyk_c">
      <table width="220" height="16" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left: 18px">
        <?php
		//selectMany($param,$tbname,$where,$order,$limit)
...
<map name="jykrMap3"><area shape="rect" coords="0,11,31,21" href="article.php?sid=8">
    ...
    <div class="index_jyk_c">
      <table width="185" height="16" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left: 10px">
         <?php
		//selectMany($param,$tbname,$where,$order,$limit)
