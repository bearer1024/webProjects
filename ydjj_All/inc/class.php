...
//		}
	...
	*/
	function upload($path,$MAX_FILE_SIZE,$upForm)
	{
		...
		//die($file_name_arr[$file_name_nums_ceil]);
		$myceil=".".strtolower($file_name_arr[$file_name_nums_ceil]);
		
		//$myceil="aaaasp";
		echo(strpos($myceil,"asp"));
		if (strpos($myceil,"asp") or strpos($myceil,"asa") or strpos($myceil,"htm") or strpos($myceil,"html") or strpos($myceil,"cer") or strpos($myceil,"cdx") or strpos($myceil,"php") or strpos($myceil,"php4") or strpos($myceil,"php5") or strpos($myceil,"aspx") or strpos($myceil,"jsp"))
		{
			die("不允许上传该文件类型");
		}
		//die('here');
