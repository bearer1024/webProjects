...
<div class="zhifu_content">
     ...
     if($_GET["act"]=="email")
	 {
		...
		$mailsubject=@iconv("UTF-8", "gb2312", "欢迎使用于都家教网");//如果你页面为UTF-8，这里还要转码一下
		$mima=rand(10000000,99999999);
		$pwd=md5($mima);
		$mailbody = "尊敬的会员,欢迎您注册师资最雄厚的于都家教网(<a href='http://www.bandit6.com' target='_blank'>www.bandit6.com</a>)<br>请妥善保留这封电子邮件. 您的帐号资料如下<br><br>登陆帐号:&nbsp;<span style='color:#ff0000'>".$_POST["uname"]."</span><br>您登陆的新密码:&nbsp;<span style='color:#ff0000'>".$mima."</span><br><br>请妥善保管.";    //邮件内容
