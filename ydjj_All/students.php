...
{
setcookie("cookie_lang","默认城市", time()+2592000);
echo "<script language='javascript'>window.location.href='index.php';  </script>";
}
		   ...
		   <div id="bot">
				...
				<div class="lctwo">
					 ...
					 <div class="lctwo_mid">
						  ...
						  <div class="lctwo_mid_nr">说明：<a href="articleshow.php?id=103" target="_blank"><font color="#fd7933">含代收学员会员费</font></a></div>
					 </div>
					 <div class="lctwo_bot"></div>
				</div>
		    ...
		    <form name="form1" method="post" action="?action=search">
			  ...
			  <tr>
				<td width="780" align="left">
				    &nbsp;订单编号：
				    <input name="ddbh" type="text" id="ddbh" size="12" style="width:70px">
				    &nbsp;科目：<input name="qjkm" type="text" id="qjkm" size="12" style="width:70px">
			   ...
			   <td width="70" align="left"><a href="students.php?act=k"><img src="images/xyk_10.jpg"></a></td>
			  </tr>
			</table>
			</form>
	      </div>
