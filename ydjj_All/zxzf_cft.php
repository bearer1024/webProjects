...
<form name="zfb" method="post" action="tenpay/index.php" target="_blank">
    <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
		...
		?> 
          财付通在线付款</strong>
            ...
            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊敬的用户，您好！为了您的方便，我们暂时关闭支付接口，只要上传的资料正确，
              我们将按照您的资历来排名。同时如果您喜欢我们于都家教网，并且想为我们于都家教网提供资金捐助，
              请到银行卡转账模块为我们捐赠，我们将把于都家教网做的更好，为大家提供更好服务，谢谢您的支持！</span>
            </div>
          </div></td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="left" valign="middle"><input type="text" name="amount" id="amount" value="0.00" style="text-align: center;background-color: beige;" disabled="true">
          元
      ...
      <tr>
        <td height="80" colspan="2" align="center" valign="middle"><img src="images/ljzf.jpg" width="150" height="41" style="cursor:not-allowed;"></td>
      </tr>
    </table>
    </form>
