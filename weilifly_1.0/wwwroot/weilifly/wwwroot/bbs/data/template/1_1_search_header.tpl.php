...
0
|| checktplrefresh('./template/default/search/header.htm', './template/default/common/header_common.htm', 1405613840, '1', './data/template/1_1_search_header.tpl.php', './template/default', 'search/header')
;?>
