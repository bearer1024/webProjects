				...
				<div id="content">
					...
					<div id="right">
						<?php
							...
							if(isset($_GET['id'])){
								$id=$_GET['id'];
								$sql="SELECT case_name,gongsi_name,case_introduce FROM succeed_case where id='$id'";
							}	
							$result = mysql_query($sql);
							While($row = mysql_fetch_array($result))
							  {
							  echo "<h1>项目名称：".$row['case_name']."</h1>";
							  echo "<h3>服务公司：".$row['gongsi_name']."</h3>";	
							  echo "<p>项目介绍：".$row['case_introduce']."</P>";	
							  }
							mysql_close($con);
							?>
					</div>
