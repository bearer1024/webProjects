					...
					<div id="right">
						...
						<ul class="news">
							...
							if( $page == 1 ){
							   ...
							   $page_string = '<a href=ganhuo.php?page=1>第一页</a>|<a href=ganhuo.php?page='.($page-1).'>上一页</a>|';
							}
							if( ($page == $page_count) || ($page_count == 0) ){
							   $page_string2= '下一页|尾页';
							}else{
							   $page_string2 = '<a href=ganhuo.php?page='.($page+1).'>下一页</a>|<a href=ganhuo.php?page='.$page_count.'>尾页</a>';
							}
							...
							While($row = mysql_fetch_array($result))
							  ...
							  echo "概念名字：".$row['out_name']."";
							  echo "</br>";
							  echo "概念意思：".$row['mean']."";
							  echo "</br>";
							  echo "概念来源：".$row['source']."";
							  echo "</div>";
							  echo "</li>";
							  }
							mysql_close($con);
