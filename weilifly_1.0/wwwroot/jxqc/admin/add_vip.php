...
if (isset($_POST['submit'])) {
	...
	$sql="INSERT INTO xh_vip (vip_name,vip_info,vip_wenhua,time)
	VALUES
	('$_POST[name]','$_POST[content]','$_POST[wenhua]','$_POST[time]')";
...
<body>
<div id="myform">
	<form action="add_vip.php" method="post" enctype="multipart/form-data">
		<ul>
			<li><h3>添加会员信息</h3></li>
			<li>会员信息: <input type="text" name="name" /></li>
			
			<li>会员详细信息：<textarea cols="45" rows="15"  id="content" name="content"></textarea>
			...
			<li>会员企业文化: <input type="text" name="wenhua" /></li>
